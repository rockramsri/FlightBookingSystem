...
public class Resource {
    ...
    public static final String AIRLINE_TICKET_TABLE_NAME = "flight";
    public static final String FLIGHT_TICKET_TABLE_NAME = "flightbookingavailablity";
        ...
        ArrayList<String> tableCreationList = new ArrayList<String>() {
            {
                add("create table IF NOT EXISTS " + User_INFO_TABLE_NAME + "( " + AUTO_COLUMN
                        ...
                        + " varchar(200) );");
                add("create table IF NOT EXISTS " + AIRLINE_TICKET_TABLE_NAME + "(" + FLIGHTNUMBER_COLUMN
                ...
                add("create table IF NOT EXISTS " + FLIGHT_TICKET_TABLE_NAME + "(" + FLIGHTNUMBER_COLUMN
                        + " varchar(200)," + DEPARTURETIME_COLUMN + " varchar(100)," + ARRIVALTIME_COLUMN
                        + " varchar(100)," + FLIGHTCLASS_COLUMN + " varchar(100)," + NOOFSEATS_COLUMN + " int,"
                        + CURRENTSEATSAVAILABLE_COLUMN + " int," + COSTPERSEAT_COLUMN + " bigint ); ");
    ...
    static public Map<String, Integer> FlightId() {
        int sizeArray[] = { 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20, 20,
